import InterfaceUser from './modules/show.js';
import { DateTime } from './modules/luxon.js';
import loadColor from './modules/combination.js';
...
const completeDate = { month: 'long', day: 'numeric', year: 'numeric' };
const date = newDate.toLocaleString(completeDate);
